...
description: Executor subagent on Claude Fable 5.1 at medium reasoning effort. Use for tasks of moderate complexity, with a few interacting parts and shallow decision points. Benchmark Artificial Analysis Intelligence Index v4.3.2, 2026-09-22; Index 49, $2.98 per task, 55 output tokens/s. Follows the prompt literally; does not invent scope.
