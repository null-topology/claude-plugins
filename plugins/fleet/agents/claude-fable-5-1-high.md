...
description: Executor subagent on Claude Fable 5.1 at high reasoning effort. Use for tasks where interactions must be held in mind and easy-to-miss details noticed. Benchmark Artificial Analysis Intelligence Index v4.3, 2026-09-12; Index 51, $3.91 per task, 49 output tokens/s. Follows the prompt literally; does not invent scope.
