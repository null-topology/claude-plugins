...
description: Executor subagent on GPT-5.6 Luna at low reasoning effort. Use for straightforward tasks of any size, where the steps are clear and there are no real decision points. Benchmark Artificial Analysis Intelligence Index v4.3, 2026-09-12; Index 22, $0.01 per task, 105 output tokens/s. Follows the prompt literally; does not invent scope.
model: gpt-5.6-luna
effort: low
---
