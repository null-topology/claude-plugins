...
description: Executor subagent on Claude Sonnet 5 at xhigh reasoning effort. Use for intricate tasks, where the reasoning is visibly tangled or a lower effort has already fallen short. Benchmark Artificial Analysis Intelligence Index v4.3.2, 2026-09-25; Index 34, $2.87 per task, 67 output tokens/s. Follows the prompt literally; does not invent scope.
