...
description: Executor subagent on GPT-5.6 Terra at medium reasoning effort. Use for tasks of moderate complexity, with a few interacting parts and shallow decision points. Benchmark Artificial Analysis Intelligence Index v4.3.2, 2026-09-25; Index 30, $0.18 per task, 79 output tokens/s. Follows the prompt literally; does not invent scope.
model: gpt-5.6-terra
effort: medium
---
