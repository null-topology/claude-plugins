...
description: Executor subagent on GPT-6 Astra at high reasoning effort. Use for tasks where interactions must be held in mind and easy-to-miss details noticed. Benchmark Artificial Analysis Intelligence Index v4.3, 2026-09-12; Index 51, $1.72 per task, 48.5 output tokens/s. Follows the prompt literally; does not invent scope.
model: gpt-6-astra
effort: high
---
