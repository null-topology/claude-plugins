...
description: Executor subagent on GPT-6 Astra at max reasoning effort. Use when xhigh was not enough; this is the model's reasoning ceiling. Benchmark Artificial Analysis Intelligence Index v4.3.2, 2026-09-25; Index 53, $3.26 per task, 52 output tokens/s. Follows the prompt literally; does not invent scope.
model: gpt-6-astra
effort: max
---
