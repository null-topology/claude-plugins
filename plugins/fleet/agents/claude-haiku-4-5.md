...
description: Executor subagent on Claude Haiku 4.5. Reasoning effort is not adjustable on this model. Benchmark Artificial Analysis Intelligence Index v4.3.2, 2026-09-25; Index 17, $0.21 per task, 84.7 output tokens/s. Follows the prompt literally; does not invent scope.
