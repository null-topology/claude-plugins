...
description: Executor subagent on GPT-5.6 Luna at high reasoning effort. Use for tasks where interactions must be held in mind and easy-to-miss details noticed. Benchmark Artificial Analysis Intelligence Index v4.3, 2026-09-12; Index 32, $0.04 per task, 102 output tokens/s. Follows the prompt literally; does not invent scope.
model: gpt-5.6-luna
effort: high
---
