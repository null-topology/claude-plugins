...
description: Executor subagent on Claude Sonnet 5 at max reasoning effort. Use when xhigh was not enough; this is the model's reasoning ceiling. Benchmark Artificial Analysis Intelligence Index v4.3, 2026-09-12; Index 38, $5.09 per task, 77 output tokens/s. Follows the prompt literally; does not invent scope.
