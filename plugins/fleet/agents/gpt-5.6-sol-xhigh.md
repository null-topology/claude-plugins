...
description: Executor subagent on GPT-5.6 Sol at xhigh reasoning effort. Use for intricate tasks, where the reasoning is visibly tangled or a lower effort has already fallen short. Benchmark Artificial Analysis Intelligence Index v4.3, 2026-09-12; Index 44, $1.18 per task, 61 output tokens/s. Follows the prompt literally; does not invent scope.
model: gpt-5.6-sol
effort: xhigh
---
